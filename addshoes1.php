...
`sto_id`='".mysql_real_escape_string($_GET['stoid'])."',
`loc_id`='".mysql_real_escape_string($_GET['locid'])."' where soe_id=".$_GET['id'];
...
`shc_id`='".mysql_real_escape_string($_POST['shc_id'])."',
`sto_id`='".mysql_real_escape_string($_GET['stoid'])."',
`loc_id`='".mysql_real_escape_string($_GET['locid'])."'";
...
?>
<script>
location.href='addshoecolor1.php?soeid=<?php echo $id; ?>';
</script>
<?php
}
}
...
<form class="form" id="add_shoe" name="add_shoe" method="post" action="" enctype="multipart/form-data" style="padding-left:10px">
