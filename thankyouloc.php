...
$rs1=mysql_query("select * from soe_members where mem_id=".$row['mem_id']);		
$row1=mysql_fetch_array($rs1);

$rs2=mysql_query("select * from soe_packages where packageid=".$row['packageid']);		
...
<br />
			...
			';
					...
					$mail = new PHPMailer();
					$mail->IsHTML(true);
					$mail->Subject ="ShoeBreeze - Payment Successful For New Location!";
...
<?php include("left3.php"); ?>
  ...
  <div>
    ...
    <p class="blue_bold">
            Thank You !!.. New location added.</p>
      <div class="clear"></div>
</div>
