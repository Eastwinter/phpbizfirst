...
mysql_query("delete from soe_membership where memshipid=".$_SESSION['delmemshipid']) or die(mysql_error());	
mysql_query("update soe_membership set memshipid=".$_SESSION['delmemshipid'].' where memshipid='.$_GET['memshipid']) or die(mysql_error());	
...
?>
    ...
    <div class="container">
      ...
      <div class="mid_body">
        <div class="heading">
          <h1><img src="images/icon_Featuerprojects.gif" width="66" height="41">Payment Successful!</h1>
        </div>
        <div id="Logoutpage">
          <div id="logoutdetail"><br /><br /><br /><br /><br /><br />
            <p>Thank You !!.. You can now login to your account and start using the My Account features.</p>
          </div>
        </div>
