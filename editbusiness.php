...
if($_POST['hour_type']==2)
{
	...
	$sql="update soe_stores set business_name='".$_POST['business_name']."',address='".$_POST['address']."',zip_code='".$_POST['zip_code']."',con_id='".$_POST['con_id']."',sta_id='".$_POST['sta_id']."',cty_id='".$_POST['city']."',display_address='".$dispaddr."' where sto_id=".$_GET['id']."";
...
$(document).ready(function() {
	$("#store_details").validate({
		...
		messages: {
			...
			terms: "<br/>Terms of store required.",
 	...
 	if($cty_id>0 and $sta_id>0 and $con_id>0)
		...
		?>
                  ...
                  <p> <b>Company Slogan Text</b><span class="mark">*</span> &nbsp; &nbsp;(50 Characters)<br />
                    ...
                    <input name="slogan_text" type="text" id="slogan_text"  style="width:300px;" value="<?php echo $slogan_text; ?>" size="40" />
                  </p>
				...
				<select name="storeopen[]" onchange="javascript: showhours(this,1);" >
						  ...
						  ?>
                          <span id="hfr1" <?php echo $s; ?> ><input autocomplete="OFF" name="hour_fr[]" class="input_box2" id="hour_fr1" readonly="readonly" type="text" value="<?php echo $hfr[0]; ?>" /> 
				  to 
		  <input autocomplete="OFF" name="hour_to[]" class="input_box2" id="hour_to1" readonly="readonly" type="text" value="<?php echo $hto[0]; ?>" ></span>
				...
				<select name="storeopen[]" onchange="javascript: showhours(this,2);" >
						 ...
						 if($storearr[1]==1)
						  	...
						  	$s=' style="visibility:hidden" ';
						  ?>
                          <span id="hfr2" <?php echo $s; ?> > <input autocomplete="OFF" name="hour_fr[]" class="input_box2" id="hour_fr2" readonly="readonly" type="text" value="<?php echo $hfr[1]; ?>" > to <input autocomplete="OFF" name="hour_to[]" class="input_box2" id="hour_to2" readonly="readonly" type="text" value="<?php echo $hto[1]; ?>" ></span>
				...
				<p>
				 <select name="storeopen[]" onchange="javascript: showhours(this,3);" >
						  ...
						  if($storearr[2]==1)
						  	...
						  	$s=' style="visibility:hidden" ';
						  ?>
                          <span id="hfr3" <?php echo $s; ?> > <input autocomplete="OFF" name="hour_fr[]" class="input_box2" id="hour_fr3" readonly="readonly" type="text" value="<?php echo $hfr[2]; ?>" > to <input autocomplete="OFF" name="hour_to[]" class="input_box2" id="hour_to3" readonly="readonly" type="text" value="<?php echo $hto[2]; ?>" ></span>
				  ...
				  <select name="storeopen[]" onchange="javascript: showhours(this,4);" >
                          ...
                          &nbsp;&nbsp;
						   ...
						   if($storearr[3]==1)
						  	...
						  	$s=' style="visibility:hidden" ';
						  ?>
                          <span id="hfr4" <?php echo $s; ?> ><input autocomplete="OFF" name="hour_fr[]" class="input_box2" id="hour_fr4" readonly="readonly" type="text" value="<?php echo $hfr[3]; ?>" > to <input autocomplete="OFF" name="hour_to[]" class="input_box2" id="hour_to4" readonly="readonly" type="text" value="<?php echo $hto[3]; ?>" ></span>
				...
				<select name="storeopen[]" onchange="javascript: showhours(this,5);" >
                          ...
                          &nbsp;&nbsp;
						   ...
						   if($storearr[4]==1)
						  	...
						  	$s=' style="visibility:hidden" ';
						  ?>
                          <span id="hfr5" <?php echo $s; ?> > <input autocomplete="OFF" name="hour_fr[]" class="input_box2" id="hour_fr5" readonly="readonly" type="text" value="<?php echo $hfr[4]; ?>" > to <input autocomplete="OFF" name="hour_to[]" class="input_box2" id="hour_to5" readonly="readonly" type="text" value="<?php echo $hto[4]; ?>" ></span>
				 ...
				 <select name="storeopen[]" onchange="javascript: showhours(this,6);" >
                          ...
                          &nbsp;&nbsp;
						   ...
						   if($storearr[5]==1)
						  	...
						  	$s=' style="visibility:hidden" ';
						  ?>
                          <span id="hfr6" <?php echo $s; ?> > <input autocomplete="OFF" name="hour_fr[]" class="input_box2" id="hour_fr6" readonly="readonly" type="text" value="<?php echo $hfr[5]; ?>" > to <input autocomplete="OFF" name="hour_to[]" class="input_box2" id="hour_to6" readonly="readonly" type="text" value="<?php echo $hto[5]; ?>" ></span>
			...
			<select name="storeopen[]" onchange="javascript: showhours(this,7);" >
						  ...
						  if($storearr[6]==1)
						  	...
						  	$s=' style="visibility:hidden" ';
						  ?>
                          <span id="hfr7" <?php echo $s; ?> >	 <input autocomplete="OFF" name="hour_fr[]" class="input_box2" id="hour_fr7" readonly="readonly" type="text" value="<?php echo $hfr[6]; ?>" > to <input autocomplete="OFF" name="hour_to[]" class="input_box2" id="hour_to7" readonly="readonly" type="text" value="<?php echo $hto[6]; ?>" ></span>
			...
			while($row=mysql_fetch_array($rs))
			{
				if(in_array($row['pay_id'],$a))
					...
					$c='';
			?>
			<input name="payment_methods[]" value="<?php echo $row['pay_id']; ?>" type="checkbox" <?php echo $c; ?> > <?php echo $row['name']; ?>
              <?php
			  	if($n%2==0)
					echo '<br class="clear">';
				$n++;
			  ...
			  ?>
                  ...
                  <p><b>Public Transportation:</b><br />
                      <textarea name="transportation" cols="50" rows="4" id="transportation"><?php echo $transportation; ?></textarea>
                      <br />
                  </p>
                  <p><b>Directions:</b><br />
                      <textarea name="directions" cols="50" rows="4" id="directions"><?php echo $directions; ?></textarea>
                      <br />
                  </p>
                  <p><b>General Information:</b><br />
                    Describe your business and the types of products or services you offer.<br />
                    <textarea name="general_information" cols="50" rows="4" id="general_information"><?php echo $general_information; ?></textarea>
                    <br />
                  </p>
                  <p style="text-align:right; margin-right:150px;">Allowed Characters : 1000</p>
                  <p><b>Affilication, Certifacations, or Licences:</b><br />
                      <textarea name="certification" cols="50" rows="4" id="certification"><?php echo $certification;?></textarea>
                      <br />
                  </p>
                  <p style="text-align:right; margin-right:150px;">Allowed Characters : 99</p>
                  <p><b>Terms and Conditions:</b><span class="mark">*</span><br />
                      <textarea name="terms" cols="50" rows="4" id="terms"><?php echo $terms; ?></textarea>
                  </p>
                  <p>
