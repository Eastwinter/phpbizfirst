...
$(document).ready(function() { 
	...
	a=document.savefrm.title.value;
	a=a.trim();
		if(a=='')
  ...
  <?php
   ...
   ?>
   	<div id="savefrmdiv">
            ...
            <strong>Enter Title and Click 'Save' To Save This Search:</strong> <input name="title" type="text" id="title" value="" maxlength="20" />
            &nbsp;&nbsp;
   ...
   <script>
				...
				function chk(obj)
				{
					if(obj.checked==true)
					{
						if(cnt==3)
						{
							alert("You can compare only 3 shoes at a time");
							obj.checked=false;
							return
						}
						cnt++;
				...
				{
					if(cnt<=0)
						alert("Please select shoes to compare");
					else if(cnt==1)
						alert("Please select atleaset 2 shoes to compare");					
					else
				...
				{
					cnt=0;
					a=document.comparefrm.elements['chkbox[]'];
					//alert(a.length);
...
var http = createRequestObject();
			...
			function shcalc(curpage,ja)
			{
				c='srchajax.php?curpage='+curpage+'&ja='+ja+'#pagination';
				http.open('get', c);
			...
			function handlecalc()
			{
					if(http.readyState == 1){
						document.getElementById("content_area_mid_inner1").innerHTML='<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><center><img src="throbber.gif"></center>';
					}
		
					if(http.readyState == 4)
					{
						
						document.getElementById("content_area_mid_inner1").innerHTML=http.responseText;
						$j('.mycarousel').jcarousel();
					}
			}
