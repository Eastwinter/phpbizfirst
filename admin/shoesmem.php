...
$().ready(function()
{
	$("#object").animate({ 
		...
		<table width="95%" border="0" cellpadding="0" cellspacing="0" align="center">		
			<tr>
				<td class="header">Shoes Added By Members</td>
			</tr>
...
<form name="site_banners" method="post" action="">
				...
				<tr class="tableheader1">
				  ...
				  <td width="17%">Name</td>
				  <td width="4%">Price</td>
				  <td width="26%">Added By</td>
				  <td width="14%">Added On</td>
		...
		$sql="select * from soe_shoe where mem_id in (select mem_id from soe_members where member_type='mem')";
		...
		$rs=mysql_query($sql) or die(mysql_error());
				...
				?>
					<tr class="tbl_text">
						...
						<td><?php echo $a; ?></td>
						<td><a href="shoesmemreviews.php?id=<?php echo $soe_id; ?>">Reviews</a></td>
						<td><a href="addshoemem.php?id=<?php echo $soe_id; ?>">
				...
				<tr class="tblrow">
					<td colspan="11" align="left" valign="middle" class="tac_ptb"><a href="javascript: selactiv(3);"><img src="images/delete.gif" alt="edit" border="0" align="absmiddle" title="click to delete" />&nbsp;</a><a href="javascript: selactiv(1);"><img src="images/do-publish.png" alt="edit" border="0" align="absmiddle" title="click to active" /></a>&nbsp;<a href="javascript: selactiv(2);"><img src="images/do-unpublish.png" alt="edit" border="0" align="absmiddle" title="click to inactive" /></a>
					  <button type="button" onclick="javascript: location.href='addshoemem.php';" class="button">Add New Shoes</button>
					</td>
		        </tr>
				<tr class="tblrow">
				  <td colspan="11" align="left" valign="middle" class="tac_ptb"><?php
			 if($totpages>1)
			 {
			 ?>
             <div class="feedbuttons">
                  <p class="buttons">
                   ...
                   <?php 
		  if($curpage>1)
		  	$l='shoesmem.php?curpage='.($curpage-1);
		   else
		  	$l='shoesmem.php?curpage='.($curpage);
		  ?> 
