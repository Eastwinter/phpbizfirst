...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	$sql="insert into`soe_packages` set
`code` ='".$_POST['code']."',
`name`  ='".$_POST['name']."',
`shoes`  ='".$_POST['shoes']."',
...
<div class="body" id="mk_height">
		...
		<Table width="95%" border="0" cellpadding="0" cellspacing="0" align="center">		
			<tr>
				<td class="header">Add New Package</td>
			</tr>
			<tr>
				<td width="100%">					
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="5" align="ceneter" class="marginTop">
						  ...
						  <td><input type="text" name="name" value="<?php echo $name; ?>" class="input_box" id="name" maxlength="250" /></td>
							...
							<tr>
								...
								<td><input type="text" name="stores" value="1" class="input_box" id="stores" maxlength="250" readonly="readonly" /> 
								(no. of stores for each package will always be 1)</td>
							</tr>
