...
<div class="body" id="mk_height">
	  <table width="95%" border="0" align="center" cellpadding="5" cellspacing="0">
        <tr>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <input type="button" name="button3" id="button3" value="          EXPORT TO EXCEL          " onclick="javascript: location.href='exporttoexcel.php?stat=9&amp;d1=<?php echo $d1; ?>&amp;d2=<?php echo $d2; ?>&amp;period=<?php echo $period; ?>';" /></td>
        </tr>
        <tr>
