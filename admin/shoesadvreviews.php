...
<form name="site_banners" method="post" action="">
				...
				<tr class="tableheader1">
				  <td width="3%"><input type="hidden" name="hfld" id="hfld" /></td>
					...
					<td width="16%">Overall</td>
					<td width="6%">Style </td>
					<td width="6%">Comfort</td>
					<td width="10%">Status</td>
				</tr>
                <?php
				
	$rs=mysql_query("select * from soe_reviews where fldshoeid=".$_GET['id']." and overall>0 and email<>'' and fldtype='review' order by flddate desc") or die(mysql_error());
				...
				<tr class="tblrow">
					<td colspan="11" align="left" valign="middle" class="tac_ptb"><a href="javascript: selactiv(3,'delete');"><img src="images/delete.gif" alt="edit" border="0" align="absmiddle" title="click to delete" /></a>&nbsp;&nbsp;<a href="javascript: selactiv(1,'activate');"><img src="images/do-publish.png" alt="edit" border="0" align="absmiddle" title="click to active" /></a>&nbsp;&nbsp;<a href="javascript: selactiv(2,'deactivate');"><img src="images/do-unpublish.png" alt="edit" border="0" align="absmiddle" title="click to inactive" /></a></td>
		        </tr>
			</form>
		</table>
</div>
