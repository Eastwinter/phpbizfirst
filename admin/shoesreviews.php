...
<form name="site_banners" method="post" action="">
                ...
                <?php
					...
					$rs=mysql_query("select * from soe_reviews where fldshoeid=".$_GET['id']." and sto_id=0 and fldtype='review' order by flddate desc") or die(mysql_error());
				...
				?>
					<tr class="tbl_text">
						...
						<td><?php echo date('F d, Y',$flddate); ?></td>
						<td><?php echo $nm; ?></td>
				...
				<tr class="tblrow">
					<td colspan="8" align="left" valign="middle" class="tac_ptb"><a href="javascript: selactiv(3);"><img src="images/delete.gif" alt="edit" border="0" align="absmiddle" title="click to delete" />&nbsp;</a><a href="javascript: selactiv(1);"><img src="images/do-publish.png" alt="edit" border="0" align="absmiddle" title="click to active" /></a>&nbsp;<a href="javascript: selactiv(2);"><img src="images/do-unpublish.png" alt="edit" border="0" align="absmiddle" title="click to inactive" />
