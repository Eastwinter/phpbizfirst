...
<input name="shoe_lace" value="0" type="radio" <?php if($_POST['lace']=='0') { ?> checked="checked" <?php } ?>  />No
				...
				<li>
					Color<br>
                     <input name="maincolor" id="maincolor" size="7" maxlength="80" value="" style="width: 80px; " type="text" />
            <img src="images/color.png" width="16" height="16" align="absmiddle" style="cursor: pointer;" onclick="openPicker('maincolor')" /> </li>
            
           <li>Advance Color Options<a href="#" class="example88 orange style1"><img src="images/color.png" width="16" height="16" align="absmiddle" style="cursor: pointer;"  /></a></li>
			</div>
