...
`certification`='".mysql_real_escape_string($_POST['certification'])."',`terms`='".mysql_real_escape_string($_POST['terms'])."',
...
mysql_query($sql) or die(mysql_error());
		...
		?>
        <script>
		location.href='packages1.php?stoid=<?php echo $id; ?>&diff=<?php echo $_GET['diff']; ?>';
		</script>
        <?php
}
...
//  {
$storesexist=0;
	$rs=mysql_query("select * from soe_stores where mem_id=".$_SESSION['memberid'].' order by sto_id');
  ...
  if($_GET['diff']=='false')
  {
		...
		?>
            ...
            <p> <b>Company Slogan Text</b><span class="mark">*</span> &nbsp; &nbsp;(50 Characters)<br />
              ...
              <input name="slogan_text" type="text" id="slogan_text"  style="width:300px;" size="40" />
            </p>
            ...
            <p><b>Cross Street:</b><br />
                <input name="cross_street" type="text" id="cross_street" value="" size="40" />
                <br />
            </p>
            <p><b>Public Transportation:</b><br />
                <textarea name="transportation" cols="40" rows="4" id="transportation"></textarea>
                <br />
            </p>
            <p><b>Directions:</b><br />
                <textarea name="directions" cols="40" rows="4" id="directions"></textarea>
                <br />
            </p>
            <p><b>General Information:</b><br />
              Describe your business and the types of products or services you offer.<br />
              <textarea name="general_information" cols="40" rows="4" id="general_information"></textarea>
              <br />
            </p>
            <p style="text-align:right; margin-right:150px;">Allowed Characters : 1000</p>
            <p><b>Affilication, Certifacations, or Licences:</b><br />
                <textarea name="certification" cols="40" rows="4" id="certification"></textarea>
                <br />
            </p>
            <p style="text-align:right; margin-right:150px;">Allowed Characters : 99</p>
            <p><b>Terms and Conditions:</b><span class="mark">*</span><br />
                <textarea name="terms" cols="40" rows="4" id="terms"></textarea>
            </p>
            <p>
            ...
            <p>
              <input name="submit" type="image" src="images/submit_button.jpg">
            </p>
          </div>
        </div>
      </form>
