...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	for($i=0;$i<=6;$i++)
	{
		...
		if($size>$settings['up_max_size'])
		{
			...
			?>
            <script>
			location.href='addshoecolor1.php?msg=size&soeid=<?php echo $_GET['soeid']; ?>';
			</script>
            <?php
			die();
		}
...
?>
<script>
location.href='addshoecolor1.php?soeid=<?php echo $_GET['soeid']; ?>';
</script>
<?php							
...
<?php include("left3.php"); ?>
  <div id="content_area_mid_inner1">
   ...
   <div>
      <h2>Add/Edit Shoe Colors</h2>
    </div>
  
    <div id="border1">
    
    
    <form id="add_shoe" name="add_shoe" method="post" action="" enctype="multipart/form-data" style="padding-left:10px;">
...
<strong>Advance Color Options</strong> <a href="#" class="example88 orange style1"><img src="images/color.png" border="0" align="absmiddle" style="cursor:pointer;"  /></a></div>
          ...
          <div class="input">
            <input name="submit" value="Save and Add More Colors" class="bttn" type="submit" />
              ...
              <input name="submit3" value="CANCEL" class="bttn" type="button" onclick="javascript: location.href='shoecolors1.php?soeid=<?php echo $_GET['soeid']; ?>';" />
          </div>
              <br class="clear" />
            </form>
