...
//				states = $("states",xml).get(id);				
	...
	$("#city1").autocomplete("populatecity.php",
		{
			delay:10,
			minChars:2,
			matchSubset:1,
...
?>
 ...
 else
 {
 	if(in_array('More Marketing',$arrpriv))
		echo ' <li class="navigation_current_link"><a href="moremarketing.php" class="white_link">More Marketing</a></li>';

	if(in_array('Edit Profile',$arrpriv))
		echo '<li class="navigation_current_link"><a href="advprofile.php" class="white_link">Edit Profile</a></li>';

	if(in_array('My Stores',$arrpriv))
		echo '<li class="navigation_current_link"><a href="mystores.php" class="white_link">My Stores</a></li>';

	if(in_array('Edit Inventory',$arrpriv))
		echo ' <li class="navigation_current_link"><a href="advshoes.php" class="white_link">Edit Inventory</a></li>';

	if(in_array('SB Database',$arrpriv))
		echo '<li class="navigation_current_link"><a href="sbdatabase.php" class="white_link">SB Database</a></li>';

	if(in_array('Purchase Lot',$arrpriv))
		echo '<li class="navigation_current_link"><a href="advpurchaselot.php" class="white_link">Purchase Lot</a></li>';

	if(in_array('Feedback',$arrpriv))
		echo '<li class="navigation_current_link"><a href="advfeedback.php" class="white_link">Feed Back</a></li>';

	if(in_array('Statistics',$arrpriv))
		echo '<li class="navigation_current_link"><a href="advstatistics.php" class="white_link">Statistics</a></li>';

	if(in_array('Saved Searches',$arrpriv))
		echo '<li><a href="advsavedsearches.php" class="white_link">Saved Searches</a></li> ';
 }
 ?>
  </ul>
  </div>
  ...
  <form action="sbdatabase.php" method="post" name="srchfrm" id="srchfrm">
    ...
    <div id="content_area_left_inner_inner">
      ...
      <ul>
        <li> Product Name<br>
          ...
          <input name="shoe_name" type="text" class="txt_box" size="15" id="shoe_name" />
        </li>
        ...
        <li> City <br>
          ...
          <input name="city1" type="text" class="txt_box" size="15" id="city1" autocomplete="off" />
        </li>
        <li> Zipcode<br>
          
          <input name="zipcode" type="text" class="txt_box" size="15" id="zipcode" />
        </li>
      </ul>
      <div><input type="image" src="images/submit_search.jpg" alt="" border="0" class="img"></a></div>
    </div>
