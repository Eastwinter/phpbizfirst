...
?>
        ...
        <input type="hidden" name="return" value="http://www.innogenius.com/shoebreeze/thankyou.php?memshipid=<?php echo $_GET['memshipid']; ?>">
        <input type="hidden" name="cancel_return" value="http://www.innogenius.com/shoebreeze/cancel.php?memshipid=<?php echo $_GET['memshipid']; ?>">
